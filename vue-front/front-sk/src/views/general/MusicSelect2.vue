 <template>   
    <div>
    <div class="wrapper" id="MusicSelect">
      <div class="player">
        <div class="player__top">
          <div class="player-cover">
            <transition-group :name="transitionName">
                <div class="player-cover__item" :style="{ backgroundImage: `url(${track.cover})` }"  v-for="(track, $index) in tracks" :key="$index">
                    <div v-if="$index === currentTrackIndex"></div>
                </div>
            </transition-group>
          </div>
